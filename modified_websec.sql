...
CREATE TABLE `assignments` (
  ...
  KEY `assignments_uploaded_by_foreign` (`uploaded_by`),
  CONSTRAINT `assignments_course_id_foreign` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`) ON DELETE CASCADE,
  CONSTRAINT `assignments_uploaded_by_foreign` FOREIGN KEY (`uploaded_by`) REFERENCES `users` (`id`) ON DELETE CASCADE
...
INSERT INTO `cache` VALUES ('secure-study-cache-moaz@gmail.com|127.0.0.1','i:1;',1781080077),('secure-study-cache-moaz@gmail.com|127.0.0.1:timer','i:1781080077;',1781080077);
...
CREATE TABLE `grade_reviews` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `grade_reviews_submission_id_foreign` (`submission_id`),
  CONSTRAINT `grade_reviews_submission_id_foreign` FOREIGN KEY (`submission_id`) REFERENCES `submissions` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `grade_reviews`
--

LOCK TABLES `grade_reviews` WRITE;
/*!40000 ALTER TABLE `grade_reviews` DISABLE KEYS */;
/*!40000 ALTER TABLE `grade_reviews` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `migrations` VALUES (1,'0001_01_01_000000_create_users_table',1),(2,'0001_01_01_000001_create_cache_table',1),(3,'0001_01_01_000002_create_jobs_table',1),(4,'2026_06_10_070136_create_courses_table',1),(5,'2026_06_10_070145_create_enrollments_table',1),(6,'2026_06_10_070152_create_assignments_table',1),(7,'2026_06_10_070158_create_submissions_table',1),(8,'2026_06_10_070204_create_grade_reviews_table',1),(9,'2026_06_10_071100_create_permission_tables',2);
...
INSERT INTO `password_reset_tokens` VALUES ('abdullah@gmail.com','$2y$12$miEGEuSU81HUOqerpg5AseXGU3apCeZUpA47iV81lIQ485.n2m6aq','2026-06-10 05:17:32');
...
INSERT INTO `permissions` VALUES (1,'upload_content','web','2026-06-10 04:11:50','2026-06-10 04:11:50'),(2,'enroll_course','web','2026-06-10 04:11:50','2026-06-10 04:11:50'),(3,'submit_assignment','web','2026-06-10 04:11:50','2026-06-10 04:11:50'),(4,'view_submissions','web','2026-06-10 04:11:50','2026-06-10 04:11:50'),(5,'assign_roles','web','2026-06-10 04:11:50','2026-06-10 04:11:50');
...
INSERT INTO `role_has_permissions` VALUES (1,1),(1,2),(2,1),(2,3),(3,1),(3,3),(4,1),(4,2),(5,1);
...
INSERT INTO `roles` VALUES (1,'course_admin','web','2026-06-10 04:11:50','2026-06-10 04:11:50'),(2,'instructor','web','2026-06-10 04:11:50','2026-06-10 04:11:50'),(3,'student','web','2026-06-10 04:11:50','2026-06-10 04:11:50');
...
INSERT INTO `sessions` VALUES ('14qBqPAbqc5rLLCJZxrdn2QLAJXQwWPxbnLSZEt5',NULL,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36','',1781078781),('9Wl7qekDeT0k056U4GtbWexhimnJuYjRwbkQIJTq',5,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36','',1781079745),('aRJMglKA9PNK7eCKHECbZsMD4hIZ8eiBkRYlwK9P',NULL,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Code/1.123.1 Chrome/148.0.7778.97 Electron/42.2.0 Safari/537.36','',1781078810),('uvumKBS0ppit2ivXerMShoIeIOi8h93l6zW4VscW',5,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/149.0.0.0 Safari/537.36','',1781079929);
